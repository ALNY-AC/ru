(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ru', ['exports', '@angular/forms', '@angular/common', '@angular/core'], factory) :
    (factory((global.ru = {}),global.ng.forms,global.ng.common,global.ng.core));
}(this, (function (exports,forms,common,i0) { 'use strict';
    ...
    var RuService = /** @class */ (function () {
        ...
        /** @nocollapse */ RuService.ngInjectableDef = i0.defineInjectable({ factory: function RuService_Factory() { return new RuService(); }, token: RuService, providedIn: "root" });
        return RuService;
    }());
    ...
    var InputComponent = /** @class */ (function () {
        function InputComponent() {
            this.prefixIcon = '';
            this.suffixIcon = '';
            this.suffixIconClick = new i0.EventEmitter(); // handle on the input icon
            // handle on the input icon
            this.prefixIconClick = new i0.EventEmitter(); // handle on the input icon
            // handle on the input icon
            this.model = '';
        ...
        InputComponent.propDecorators = {
            prefixIcon: [{ type: i0.Input, args: ['prefix-icon',] }],
            suffixIcon: [{ type: i0.Input, args: ['suffix-icon',] }],
            suffixIconClick: [{ type: i0.Output, args: ['suffix-click',] }],
            prefixIconClick: [{ type: i0.Output, args: ['prefix-click',] }],
            model: [{ type: i0.Input }],
    ...
    var DialogComponent = /** @class */ (function () {
        ...
        DialogComponent.propDecorators = {
            ...
            width: [{ type: i0.Input }],
            show: [{ type: i0.Input }],
            maskClose: [{ type: i0.Input, args: ['mask-close',] }],
    ...
    exports.RuService = RuService;
    exports.RuComponent = RuComponent;
    exports.RuModule = RuModule;
    exports.ɵa = ButtonComponent;
    exports.ɵh = DialogComponent;
    exports.ɵc = InputComponent;
    exports.ɵj = OptionComponent;
    exports.ɵb = PanelComponent;
    exports.ɵi = SelectComponent;
    exports.ɵd = TableComponent;
    exports.ɵf = TdComponent;
    exports.ɵe = ThComponent;
    exports.ɵg = TrComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ru.umd.js.map